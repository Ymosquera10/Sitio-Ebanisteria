                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="Promociones" required 
                                        placeholder="Promociones" value="<?php echo $producto->Promociones;?>">
                                </div>

                                 <div class="form-group">
                                    <div class="custon-file">
                                    <input type="file" class="form-control form-control-user" name="Imagen" accept="image/*"  
                                        placeholder="Imagen">
                                  </div>
                                </div>
                                </div>
